...
class SmartSceneMetadata {
  ...
  /// Creates a [SmartSceneMetadata] object from the JSON response to a GET
  /// request.
  factory SmartSceneMetadata.fromJson(Map<String, dynamic> dataMap) {
    return SmartSceneMetadata(
  ...
  /// request.
  SmartSceneMetadata copyWith({
    String? name,
    Relative? image,
    bool copyOriginalValues = true,
  }) {
    SmartSceneMetadata toReturn = SmartSceneMetadata(
  ...
  bool operator ==(Object other) {
    ...
    return other is SmartSceneMetadata &&
        other.name == name &&
        other.image == image;
  }
  ...
  @override
  String toString() =>
      "Instance of 'SmartSceneMetadata' ${toJson(optimizeFor: OptimizeFor.dontOptimize).toString()}";
}
