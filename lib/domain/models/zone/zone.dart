...
class Zone extends Resource {
  ...
  /// Creates a [Zone] object from the JSON response to a GET request.
  factory Zone.fromJson(Map<String, dynamic> dataMap) {
  ...
  @override
  String toString() =>
      "Instance of 'Zone' ${toJson(optimizeFor: OptimizeFor.dontOptimize).toString()}";
}
